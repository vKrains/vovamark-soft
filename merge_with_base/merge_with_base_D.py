...
# Пути к файлам
tasks_file = 'D:/Софт/скрипты и аутпутс/Выходы D/задания_D.xlsx'
supply_file = 'D:/Софт/скрипты и аутпутс/Выходы D/поставки_не_купили_D.xlsx'
database_file = 'D:/Софт/База данных/База данных.xlsx'
output_file = 'D:/Софт/скрипты и аутпутс/выходы/задания_с_названием_и_фото_D.xlsx'
