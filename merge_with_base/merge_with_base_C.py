...
# Пути к файлам
tasks_file = 'D:/Софт/скрипты и аутпутс/Выходы C/задания_C.xlsx'
supply_file = 'D:/Софт/скрипты и аутпутс/Выходы C/поставки_не_купили_C.xlsx'
database_file = 'D:/Софт/База данных/База данных.xlsx'
output_file = 'D:/Софт/скрипты и аутпутс/выходы/задания_с_названием_и_фото_C.xlsx'
