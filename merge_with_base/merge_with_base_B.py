...
# Пути к файлам
tasks_file = 'D:/Софт/скрипты и аутпутс/Выходы B/задания_B.xlsx'
supply_file = 'D:/Софт/скрипты и аутпутс/Выходы B/поставки_не_купили_B.xlsx'
database_file = 'D:/Софт/База данных/База данных.xlsx'
output_file = 'D:/Софт/скрипты и аутпутс/выходы/задания_с_названием_и_фото_B.xlsx'
