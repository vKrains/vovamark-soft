...
# Пути к файлам
tasks_file = 'D:/Софт/скрипты и аутпутс/Выходы E/задания_E.xlsx'
supply_file = 'D:/Софт/скрипты и аутпутс/Выходы E/поставки_не_купили_E.xlsx'
database_file = 'D:/Софт/База данных/База данных.xlsx'
output_file = 'D:/Софт/скрипты и аутпутс/выходы/задания_с_названием_и_фото_E.xlsx'
