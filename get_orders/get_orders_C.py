...
if data:
    ...
    df['Продавец'] = 'ОБЩИЙ'
    df['Группа'] = 'C'
    df.to_excel('D:/Софт/скрипты и аутпутс/Выходы C/задания_C.xlsx', index=False)
    print("Упрощённые данные сохранены в 'D:/Софт/скрипты и аутпутс/Выходы C/задания_C.xlsx'")
else:
