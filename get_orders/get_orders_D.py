...
if data:
    ...
    df['Продавец'] = 'ОБЩИЙ'
    df['Группа'] = 'D'
    df.to_excel('D:/Софт/скрипты и аутпутс/Выходы D/задания_D.xlsx', index=False)
    print("Упрощённые данные сохранены в 'D:/Софт/скрипты и аутпутс/Выходы D/задания_D.xlsx'")
else:
