...
if data:
    ...
    df['Продавец'] = 'ОБЩИЙ'
    df['Группа'] = 'E'
    df.to_excel('D:/Софт/скрипты и аутпутс/Выходы E/задания_E.xlsx', index=False)
    print("Упрощённые данные сохранены в 'D:/Софт/скрипты и аутпутс/Выходы E/задания_E.xlsx'")
else:
