...
from config import API_B

HEADERS = {'Authorization': API_B}
...
if data:
    ...
    df['Продавец'] = 'B'
    df['Группа'] = 'B'
    df.to_excel('D:/Софт/скрипты и аутпутс/Выходы B/задания_B.xlsx', index=False)
    print("Упрощённые данные сохранены в 'D:/Софт/скрипты и аутпутс/Выходы B/задания_B.xlsx'")
else:
