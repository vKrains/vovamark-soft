...
output_folder = "D:/Софт/скрипты и аутпутс/закупленные Краснодар"
os.makedirs(output_folder, exist_ok=True)  # Создаёт папку, если её нет

# Загрузка исходной таблицы
df = pd.read_excel("D:/Софт/скрипты и аутпутс/на закупку/ЗАДАНИЯ_КРАСНОДАР.xlsx")

# Список нужных продавцов
target_sellers = ["A", "B", "C", "D", "E", "F"]
